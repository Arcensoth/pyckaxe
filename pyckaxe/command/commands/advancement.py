...
class AdvancementGRCommandMixin:
    ...
    def targets(self: CommandNode, targets: CommandTarget) -> 'AdvancementGRTargetsCommand':
        return AdvancementGRTargetsCommand(self, targets)


class AdvancementGRTargetsFTUCommandMixin:
    def __call__(self, advancement: AdvancementResourceLocation) -> 'AdvancementGRTargetsFTUAdvancementCommand':
        return self.advancement(advancement)

    def advancement(self, advancement: AdvancementResourceLocation) -> 'AdvancementGRTargetsFTUAdvancementCommand':
...
class AdvancementGRTargetsOnlyCommand(CommandLiteral):
    ...
    def advancement(self, advancement: AdvancementResourceLocation) -> 'AdvancementGRTargetsOnlyAdvancementCommand':
...
class AdvancementGRTargetsOnlyAdvancementCommand(CommandArgument):
    def criteria(self, criteria: AdvancementCriteria) -> 'AdvancementGRTargetsOnlyAdvancementCriteriaCommand':
