...
class ReadableResourceRegistry(ReadableRegistryNode, Generic[ResourceType]):
    ...
    ResourceTriplet = Tuple[ResourceType, ResourceLocation[ResourceType], Path]

    def __init__(
        self, registry_location: RegistryLocation, path: Path, resource_class: Type[ResourceType]
    ):
